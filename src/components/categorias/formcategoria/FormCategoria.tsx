    ...
    return (
        ...
        <div className="flex flex-col gap-2">
               ...
               <input type="text" placeholder="Nome"
                      name='nome'className="border-2 border-slate-700 rounded p-2"
            ...
            <div className="flex flex-col gap-2">
                ...
                <input type="text" placeholder="Descreva aqui a categoria"
                       name='descricao'className="border-2 border-slate-700 rounded p-2"
                       value={categoria.descricao}
                       onChange={(e: ChangeEvent<HTMLInputElement>) => atualizarEstado(e)}/>
            </div>


            <button className="rounded text-slate-100 bg-indigo-300 hover:bg-indigo-400 w-1/2 py-2 mx-auto flex justify-center" 
                type="submit">
                  {isLoading ?
                        <RotatingLines
